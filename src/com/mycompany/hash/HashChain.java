...
class HashTableChain
{
    ...
    // -------------------------------------------------------------
    public HashTableChain(int size)        // constructor
    {
        arraySize = size;
...
class HashChainApp
{
    public static void main(String[] args) throws IOException
    {
        ...
        n = getInt();
        // make table
        HashTableChain theHashTableChain = new HashTableChain(size);
        ...
        for(int j=0; j<n; j++)         // insert data
        {
            ...
            theHashTableChain.insert(aDataItem);
        }
        while(true)                    // interact with user
        {
            ...
            {
                case 's':
                    theHashTableChain.displayTable();
                    break;
                case 'i':
                ...
                case 'd':
                    ...
                    aKey = getInt();
                    theHashTableChain.delete(aKey);
                    break;
                case 'f':
                    System.out.print("Enter key value to find: ");
                    aKey = getInt();
                    aDataItem = theHashTableChain.find(aKey);
                    if(aDataItem != null)
